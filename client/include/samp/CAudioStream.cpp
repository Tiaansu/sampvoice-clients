...
int& SAMP::CAudioStream::hStream() { return *(int*)SAMP_ADDROF(0x16C7CC); }
bool& SAMP::CAudioStream::bIsPlaying() { return *(bool*)SAMP_ADDROF(0x16C7D0); }
SAMP::CVectorSA& SAMP::CAudioStream::position() { return *(SAMP::CVectorSA*)SAMP_ADDROF(0x16C7D4); }
bool& SAMP::CAudioStream::bIs3d() { return *(bool*)SAMP_ADDROF(0x16C7E0); }
char* SAMP::CAudioStream::szIcyUrl() { return (char*)SAMP_ADDROF(0x16C6C8); }
char* SAMP::CAudioStream::szInfo() { return (char*)SAMP_ADDROF(0x16C5C0); }
char* SAMP::CAudioStream::szUrl() { return (char*)SAMP_ADDROF(0x16C4B8); }
bool& SAMP::CAudioStream::bNeedsToDestroy() { return *(bool*)SAMP_ADDROF(0x1407BA); }
float& SAMP::CAudioStream::fRadius() { return *(float*)SAMP_ADDROF(0x1407BC); }
char* SAMP::CAudioStream::szIcyName() { return (char*)SAMP_ADDROF(0x16C3B0); }
SAMP::CAudioStream*& SAMP::pAudioStream() { return *(SAMP::CAudioStream**)SAMP_ADDROF(0x2ACA1C); }

BOOL SAMP::CAudioStream::Reset() {
	return ((BOOL(__thiscall*)(CAudioStream*))SAMP_ADDROF(0x65F00))(this);
}

BOOL SAMP::CAudioStream::Stop(bool bWait) {
	return ((BOOL(__thiscall*)(CAudioStream*, bool))SAMP_ADDROF(0x65FE0))(this, bWait);
}

BOOL SAMP::CAudioStream::Play(const char* szUrl, CVectorSA position, float fRadius, bool bIs3d) {
	return ((BOOL(__thiscall*)(CAudioStream*, const char*, CVectorSA, float, bool))SAMP_ADDROF(0x663E0))(this, szUrl, position, fRadius, bIs3d);
}

void SAMP::CAudioStream::ControlGameRadio() {
	((void(__thiscall*)(CAudioStream*))SAMP_ADDROF(0x66500))(this);
}

void SAMP::CAudioStream::DrawInfo() {
	((void(__thiscall*)(CAudioStream*))SAMP_ADDROF(0x66530))(this);
}

void SAMP::CAudioStream::ConstructInfo() {
	((void(__cdecl*)())SAMP_ADDROF(0x66040))();
}

void SAMP::CAudioStream::SyncProc(int handle, int channel, int data, void* user) {
	((void(__stdcall*)(int, int, int, void*))SAMP_ADDROF(0x66170))(handle, channel, data, user);
}

void SAMP::CAudioStream::Process(void* arglist) {
	((void(__cdecl*)(void*))SAMP_ADDROF(0x66180))(arglist);
}
