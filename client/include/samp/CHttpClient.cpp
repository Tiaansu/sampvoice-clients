...
SAMP::CHttpClient::CHttpClient() {
	((void(__thiscall*)(CHttpClient*))SAMP_ADDROF(0x2310))(this);
}

SAMP::CHttpClient::~CHttpClient() {
	((void(__thiscall*)(CHttpClient*))SAMP_ADDROF(0x2370))(this);
}

bool SAMP::CHttpClient::GetHeaderValue(const char* szHeaderName, char* szBuffer, int nBufferLen) {
	return ((bool(__thiscall*)(CHttpClient*, const char*, char*, int))SAMP_ADDROF(0x23E0))(this, szHeaderName, szBuffer, nBufferLen);
}

void SAMP::CHttpClient::InitializeRequest(int nType, const char* szUrl, const char* szPostData, const char* szReferer) {
	((void(__thiscall*)(CHttpClient*, int, const char*, const char*, const char*))SAMP_ADDROF(0x24E0))(this, nType, szUrl, szPostData, szReferer);
}

void SAMP::CHttpClient::HandleEntity() {
	((void(__thiscall*)(CHttpClient*))SAMP_ADDROF(0x26B0))(this);
}

bool SAMP::CHttpClient::Connect(const char* szHost, int nPort) {
	return ((bool(__thiscall*)(CHttpClient*, const char*, int))SAMP_ADDROF(0x29D0))(this, szHost, nPort);
}

void SAMP::CHttpClient::Process() {
	((void(__thiscall*)(CHttpClient*))SAMP_ADDROF(0x2A90))(this);
}

void SAMP::CHttpClient::Disconnect() {
	((void(__thiscall*)(CHttpClient*))SAMP_ADDROF(0x2470))(this);
}

SAMP::CHttpClient::Error SAMP::CHttpClient::ProcessUrl(int nType, const char* szUrl, const char* szPostData, const char* szReferer) {
	return ((Error(__thiscall*)(CHttpClient*, int, const char*, const char*, const char*))SAMP_ADDROF(0x2C70))(this, nType, szUrl, szPostData, szReferer);
}

bool SAMP::CHttpClient::Send(const char* szBuffer) {
	return ((bool(__thiscall*)(CHttpClient*, const char*))SAMP_ADDROF(0x2480))(this, szBuffer);
}

int SAMP::CHttpClient::Receive(char* szBuffer, int nBufferLen) {
	return ((int(__thiscall*)(CHttpClient*, char*, int))SAMP_ADDROF(0x24C0))(this, szBuffer, nBufferLen);
}
