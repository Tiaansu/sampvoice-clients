...
SAMP::CDeathWindow*& SAMP::pDeathWindow() { return *(SAMP::CDeathWindow**)SAMP_ADDROF(0x26EB88); }

SAMP::CDeathWindow::CDeathWindow(IDirect3DDevice9* pDevice) {
	((void(__thiscall*)(CDeathWindow*, IDirect3DDevice9*))SAMP_ADDROF(0x6A650))(this, pDevice);
}

SAMP::CDeathWindow::~CDeathWindow() {
	((void(__thiscall*)(CDeathWindow*))SAMP_ADDROF(0x69B40))(this);
}

void SAMP::CDeathWindow::InitializeAuxFonts() {
	((void(__thiscall*)(CDeathWindow*))SAMP_ADDROF(0x69BB0))(this);
}

void SAMP::CDeathWindow::PushBack() {
	((void(__thiscall*)(CDeathWindow*))SAMP_ADDROF(0x69C20))(this);
}

void SAMP::CDeathWindow::DrawText(const char* szText, CRectSA rect, D3DCOLOR color, int nFormat) {
	((void(__thiscall*)(CDeathWindow*, const char*, CRectSA, D3DCOLOR, int))SAMP_ADDROF(0x69C40))(this, szText, rect, color, nFormat);
}

void SAMP::CDeathWindow::DrawWeaponSprite(const char* szSpriteId, CRectSA rect, D3DCOLOR color) {
	((void(__thiscall*)(CDeathWindow*, const char*, CRectSA, D3DCOLOR))SAMP_ADDROF(0x69D40))(this, szSpriteId, rect, color);
}

void SAMP::CDeathWindow::GetWeaponSpriteRectSize(void* pPoint) {
	((void(__thiscall*)(CDeathWindow*, void*))SAMP_ADDROF(0x69DD0))(this, pPoint);
}

const char* SAMP::CDeathWindow::GetWeaponSpriteId(char nWeapon) {
	return ((const char* (__thiscall*)(CDeathWindow*, char))SAMP_ADDROF(0x69E50))(this, nWeapon);
}

void SAMP::CDeathWindow::ResetFonts() {
	((void(__thiscall*)(CDeathWindow*))SAMP_ADDROF(0x6A150))(this);
}

void SAMP::CDeathWindow::Draw() {
	((void(__thiscall*)(CDeathWindow*))SAMP_ADDROF(0x6A2E0))(this);
}

void SAMP::CDeathWindow::AddEntry(const char* szKiller, const char* szVictim, D3DCOLOR killerColor, D3DCOLOR victimColor, char nWeapon) {
	((void(__thiscall*)(CDeathWindow*, const char*, const char*, D3DCOLOR, D3DCOLOR, char))SAMP_ADDROF(0x6A5D0))(this, szKiller, szVictim, killerColor, victimColor, nWeapon);
}

void SAMP::CDeathWindow::AddMessage(const char* szKiller, const char* szVictim, D3DCOLOR killerColor, D3DCOLOR victimColor, char nWeapon) {
	((void(__thiscall*)(CDeathWindow*, const char*, const char*, D3DCOLOR, D3DCOLOR, char))SAMP_ADDROF(0x6A6B0))(this, szKiller, szVictim, killerColor, victimColor, nWeapon);
}
