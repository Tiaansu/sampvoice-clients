...
SAMP::CPedSA::CPedSA() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAB690))(this);
}

SAMP::CPedSA::CPedSA(int nPlayerNumber, int nModel, CVectorSA position, float fRotation) {
	((void(__thiscall*)(CPedSA*, int, int, CVectorSA, float))SAMP_ADDROF(0xB08E0))(this, nPlayerNumber, nModel, position, fRotation);
}

void SAMP::CPedSA::ResetPointers() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAB7D0))(this);
}

void SAMP::CPedSA::SetInitialState() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAB7F0))(this);
}

SAMP::AimStuff::Aim* SAMP::CPedSA::GetAim() {
	return ((AimStuff::Aim * (__thiscall*)(CPedSA*))SAMP_ADDROF(0xAB810))(this);
}

void SAMP::CPedSA::SetAim(const AimStuff::Aim* pAim) {
	((void(__thiscall*)(CPedSA*, const AimStuff::Aim*))SAMP_ADDROF(0xAB850))(this, pAim);
}

char SAMP::CPedSA::GetCurrentWeapon() {
	return ((char(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAB870))(this);
}

SAMP::GTAREF SAMP::CPedSA::GetVehicleRef() {
	return ((GTAREF(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAB8B0))(this);
}

void SAMP::CPedSA::DeleteArrow() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAB8D0))(this);
}

BOOL SAMP::CPedSA::IsOnScreen() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAB900))(this);
}

void SAMP::CPedSA::SetImmunities(BOOL BP, BOOL FP, BOOL EP, BOOL CP, BOOL MP) {
	((void(__thiscall*)(CPedSA*, BOOL, BOOL, BOOL, BOOL, BOOL))SAMP_ADDROF(0xAB920))(this, BP, FP, EP, CP, MP);
}

float SAMP::CPedSA::GetHealth() {
	return ((float(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAB970))(this);
}

void SAMP::CPedSA::SetHealth(float fValue) {
	((void(__thiscall*)(CPedSA*, float))SAMP_ADDROF(0xAB990))(this, fValue);
}

float SAMP::CPedSA::GetArmour() {
	return ((float(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAB9B0))(this);
}

void SAMP::CPedSA::SetArmour(float fValue) {
	((void(__thiscall*)(CPedSA*, float))SAMP_ADDROF(0xAB9D0))(this, fValue);
}

int SAMP::CPedSA::GetFlags() {
	return ((int(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAB9F0))(this);
}

void SAMP::CPedSA::SetFlags(int nValue) {
	((void(__thiscall*)(CPedSA*, int))SAMP_ADDROF(0xABA10))(this, nValue);
}

BOOL SAMP::CPedSA::IsDead() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xABA30))(this);
}

char SAMP::CPedSA::GetState() {
	return ((char(__thiscall*)(CPedSA*))SAMP_ADDROF(0xABA60))(this);
}

void SAMP::CPedSA::SetState(char nValue) {
	((void(__thiscall*)(CPedSA*, char))SAMP_ADDROF(0xABA70))(this, nValue);
}

float SAMP::CPedSA::GetRotation() {
	return ((float(__thiscall*)(CPedSA*))SAMP_ADDROF(0xABAB0))(this);
}

void SAMP::CPedSA::ForceRotation(float fValue) {
	((void(__thiscall*)(CPedSA*, float))SAMP_ADDROF(0xABB30))(this, fValue);
}

void SAMP::CPedSA::SetRotation(float fValue) {
	((void(__thiscall*)(CPedSA*, float))SAMP_ADDROF(0xABB80))(this, fValue);
}

BOOL SAMP::CPedSA::IsPassenger() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xABBE0))(this);
}

CVehicle* SAMP::CPedSA::GetVehicle() {
	return ((::CVehicle * (__thiscall*)(CPedSA*))SAMP_ADDROF(0xABC20))(this);
}

void SAMP::CPedSA::ClearWeapons() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xABC30))(this);
}

void SAMP::CPedSA::SetArmedWeapon(int nWeapon, bool bGameFunc) {
	((void(__thiscall*)(CPedSA*, int, bool))SAMP_ADDROF(0xABC80))(this, nWeapon, bGameFunc);
}

void SAMP::CPedSA::RemoveWeaponWhenEnteringVehicle() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xABD30))(this);
}

CWeapon* SAMP::CPedSA::GetCurrentWeaponSlot() {
	return ((::CWeapon * (__thiscall*)(CPedSA*))SAMP_ADDROF(0xABD60))(this);
}

BOOL SAMP::CPedSA::CurrentWeaponHasAmmo() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xABD80))(this);
}

float SAMP::CPedSA::GetDistanceToEntity(const CEntitySA* pEntity) {
	return ((float(__thiscall*)(CPedSA*, const CEntitySA*))SAMP_ADDROF(0xABDC0))(this, pEntity);
}

int SAMP::CPedSA::GetVehicleSeatIndex() {
	return ((int(__thiscall*)(CPedSA*))SAMP_ADDROF(0xABE20))(this);
}

void SAMP::CPedSA::PutIntoVehicle(GTAREF vehicle, int nSeat) {
	((void(__thiscall*)(CPedSA*, GTAREF, int))SAMP_ADDROF(0xABEB0))(this, vehicle, nSeat);
}

void SAMP::CPedSA::EnterVehicle(GTAREF vehicle, BOOL bAsPassenger) {
	((void(__thiscall*)(CPedSA*, GTAREF, BOOL))SAMP_ADDROF(0xAC030))(this, vehicle, bAsPassenger);
}

void SAMP::CPedSA::ExitVehicle() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAC100))(this);
}

void SAMP::CPedSA::WarpFromVehicle(CVectorSA putAt) {
	((void(__thiscall*)(CPedSA*, CVectorSA))SAMP_ADDROF(0xAC190))(this, putAt);
}

void SAMP::CPedSA::SetSpawnInfo(const CVectorSA* pPosition, float fRotation) {
	((void(__thiscall*)(CPedSA*, const CVectorSA*, float))SAMP_ADDROF(0xAC370))(this, pPosition, fRotation);
}

void SAMP::CPedSA::SetControllable(BOOL bEnable) {
	((void(__thiscall*)(CPedSA*, BOOL))SAMP_ADDROF(0xAC3B0))(this, bEnable);
}

char SAMP::CPedSA::GetDeathInfo(ID* pKiller) {
	return ((char(__thiscall*)(CPedSA*, ID*))SAMP_ADDROF(0xAC470))(this, pKiller);
}

CEntity* SAMP::CPedSA::GetFloor() {
	return ((::CEntity * (__thiscall*)(CPedSA*))SAMP_ADDROF(0xAC630))(this);
}

CWeaponInfo* SAMP::CPedSA::GetCurrentWeaponInfo() {
	return ((::CWeaponInfo * (__thiscall*)(CPedSA*))SAMP_ADDROF(0xAC6E0))(this);
}

void SAMP::CPedSA::HandsUp() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAC730))(this);
}

BOOL SAMP::CPedSA::DoesHandsUp() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAC780))(this);
}

void SAMP::CPedSA::HoldObject(int nModel) {
	((void(__thiscall*)(CPedSA*, int))SAMP_ADDROF(0xAC7E0))(this, nModel);
}

BOOL SAMP::CPedSA::EnablePassengerDrivebyMode() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xACF90))(this);
}

void SAMP::CPedSA::Extinguish() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD0F0))(this);
}

unsigned short SAMP::CPedSA::GetCurrentWeaponAmmo() {
	return ((unsigned short(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD150))(this);
}

void SAMP::CPedSA::EnableJetpack() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAC930))(this);
}

void SAMP::CPedSA::DisableJetpack() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAC980))(this);
}

BOOL SAMP::CPedSA::HasJetpack() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAC9E0))(this);
}

CWeapon* SAMP::CPedSA::GetWeaponSlot(int nWeapon) {
	return ((::CWeapon * (__thiscall*)(CPedSA*, int))SAMP_ADDROF(0xACDB0))(this, nWeapon);
}

void SAMP::CPedSA::SetWalkStyle(const char* szName) {
	((void(__thiscall*)(CPedSA*, const char*))SAMP_ADDROF(0xACDF0))(this, szName);
}

void SAMP::CPedSA::PerformAnimation(const char* szName, const char* szFile, float fFramedelta, int nLoopA, int nLockX, int nLockY, int nLockF, int nTime) {
	((void(__thiscall*)(CPedSA*, const char*, const char*, float, int, int, int, int, int))SAMP_ADDROF(0xACE50))(this, szName, szFile, fFramedelta, nLoopA, nLockX, nLockY, nLockF, nTime);
}

void SAMP::CPedSA::LinkToInterior(char nId, BOOL bRefresh) {
	((void(__thiscall*)(CPedSA*, char, BOOL))SAMP_ADDROF(0xACF60))(this, nId, bRefresh);
}

void SAMP::CPedSA::DestroyParachute() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD000))(this);
}

BOOL SAMP::CPedSA::OpenParachute() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD0F0))(this);
}

void SAMP::CPedSA::ProcessParachuteEvent(const char* szName) {
	((void(__thiscall*)(CPedSA*, const char*))SAMP_ADDROF(0xAD240))(this, szName);
}

BOOL SAMP::CPedSA::IsOnGround() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD480))(this);
}

void SAMP::CPedSA::ResetDamageEntity() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD4A0))(this);
}

void SAMP::CPedSA::RemoveWeaponModel(int nWeapon) {
	((void(__thiscall*)(CPedSA*, int))SAMP_ADDROF(0xAD4D0))(this, nWeapon);
}

float SAMP::CPedSA::GetAimZ() {
	return ((float(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD510))(this);
}

void SAMP::CPedSA::SetAimZ(float fValue) {
	((void(__thiscall*)(CPedSA*, float))SAMP_ADDROF(0xAD550))(this, fValue);
}

CEntity* SAMP::CPedSA::GetContactEntity() {
	return ((::CEntity * (__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD5A0))(this);
}

CVehicle* SAMP::CPedSA::GetContactVehicle() {
	return ((::CVehicle * (__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD5B0))(this);
}

int SAMP::CPedSA::GetStat() {
	return ((int(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD5E0))(this);
}

BOOL SAMP::CPedSA::PerformingCustomAnimation() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD600))(this);
}

void SAMP::CPedSA::StartDancing(int nStyle) {
	((void(__thiscall*)(CPedSA*, int))SAMP_ADDROF(0xAD6D0))(this, nStyle);
}

void SAMP::CPedSA::StopDancing() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD720))(this);
}

BOOL SAMP::CPedSA::DoesDancing() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD760))(this);
}

const char* SAMP::CPedSA::GetAnimationForDance(int nMove) {
	return ((const char* (__thiscall*)(CPedSA*, int))SAMP_ADDROF(0xAD770))(this, nMove);
}

void SAMP::CPedSA::DropStuff() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD800))(this);
}

int SAMP::CPedSA::GetStuff() {
	return ((int(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD890))(this);
}

BOOL SAMP::CPedSA::ApplyStuff() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD8A0))(this);
}

void SAMP::CPedSA::ProcessDrunk() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAD9F0))(this);
}

int SAMP::CPedSA::GetDrunkLevel() {
	return ((int(__thiscall*)(CPedSA*))SAMP_ADDROF(0xADBA0))(this);
}

void SAMP::CPedSA::SetDrunkLevel(int nValue) {
	((void(__thiscall*)(CPedSA*, int))SAMP_ADDROF(0xADBB0))(this, nValue);
}

void SAMP::CPedSA::ApplyCommandTask(const char* szName, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10, int a11) {
	((void(__thiscall*)(CPedSA*, const char*, int, int, int, int, int, int, int, int, int))SAMP_ADDROF(0xADBD0))(this, szName, a3, a4, a5, a6, a7, a8, a9, a10, a11);
}

void SAMP::CPedSA::DestroyCommandTask() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xADC20))(this);
}

void SAMP::CPedSA::EnableCellphone(BOOL bEnable) {
	((void(__thiscall*)(CPedSA*, BOOL))SAMP_ADDROF(0xADC70))(this, bEnable);
}

BOOL SAMP::CPedSA::UsingCellphone() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xADCA0))(this);
}

void SAMP::CPedSA::SetFightingStyle(int nStyle) {
	((void(__thiscall*)(CPedSA*, int))SAMP_ADDROF(0xADCD0))(this, nStyle);
}

void SAMP::CPedSA::StartUrinating() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xADD00))(this);
}

void SAMP::CPedSA::StopUrinating() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xADDE0))(this);
}

BOOL SAMP::CPedSA::DoesUrinating() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xADE60))(this);
}

const char* SAMP::CPedSA::GetLoadedShoppingDataSubsection() {
	return ((const char* (__thiscall*)(CPedSA*))SAMP_ADDROF(0xADEE0))(this);
}

void SAMP::CPedSA::LoadShoppingDataSubsection(const char* szName) {
	((void(__thiscall*)(CPedSA*, const char*))SAMP_ADDROF(0xADF00))(this, szName);
}

CPed* SAMP::CPedSA::GetAimedPed() {
	return ((::CPed * (__thiscall*)(CPedSA*))SAMP_ADDROF(0xAEB60))(this);
}

void SAMP::CPedSA::SetKeys(short controllerState, short sLeftStickX, short sLeftStickY) {
	((void(__thiscall*)(CPedSA*, short, short, short))SAMP_ADDROF(0xAEF40))(this, controllerState, sLeftStickX, sLeftStickY);
}

short SAMP::CPedSA::GetKeys(short* pLeftStickX, short* pLeftStickY) {
	return ((short(__thiscall*)(CPedSA*, short*, short*))SAMP_ADDROF(0xAF1D0))(this, pLeftStickX, pLeftStickY);
}

void SAMP::CPedSA::CreateArrow(int nColor) {
	((void(__thiscall*)(CPedSA*, int))SAMP_ADDROF(0xAF330))(this, nColor);
}

void SAMP::CPedSA::SetModelIndex(int nModel) {
	((void(__thiscall*)(CPedSA*, int))SAMP_ADDROF(0xAFB50))(this, nModel);
}

void SAMP::CPedSA::Kill() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAFBD0))(this);
}

void SAMP::CPedSA::SetWeaponAmmo(unsigned char nWeapon, unsigned short nAmmo) {
	((void(__thiscall*)(CPedSA*, unsigned char, unsigned short))SAMP_ADDROF(0xAFC80))(this, nWeapon, nAmmo);
}

void SAMP::CPedSA::ProcessDancing() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAFCB0))(this);
}

void SAMP::CPedSA::GiveStuff(int nType) {
	((void(__thiscall*)(CPedSA*, int))SAMP_ADDROF(0xAFED0))(this, nType);
}

void SAMP::CPedSA::Destroy() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xB0BA0))(this);
}

void SAMP::CPedSA::SetCameraMode(char nMode) {
	((void(__thiscall*)(CPedSA*, char))SAMP_ADDROF(0x141E0))(this, nMode);
}

void SAMP::CPedSA::SetCameraExtZoomAndAspectRatio(float fExtZoom, float fAspectRatio) {
	((void(__thiscall*)(CPedSA*, float, float))SAMP_ADDROF(0x14200))(this, fExtZoom, fAspectRatio);
}

BOOL SAMP::CPedSA::HasAccessory() {
	return ((BOOL(__thiscall*)(CPedSA*))SAMP_ADDROF(0xAEA30))(this);
}

void SAMP::CPedSA::DeleteAccessory(int nSlot) {
	((void(__thiscall*)(CPedSA*, int))SAMP_ADDROF(0xAEA50))(this, nSlot);
}

BOOL SAMP::CPedSA::GetAccessoryState(int nSlot) {
	return ((BOOL(__thiscall*)(CPedSA*, int))SAMP_ADDROF(0xAEAB0))(this, nSlot);
}

void SAMP::CPedSA::DeleteAllAccessories() {
	((void(__thiscall*)(CPedSA*))SAMP_ADDROF(0xB06B0))(this);
}

void SAMP::CPedSA::AddAccessory(int nSlot, const Accessory* pInfo) {
	((void(__thiscall*)(CPedSA*, int, const Accessory*))SAMP_ADDROF(0xB0710))(this, nSlot, pInfo);
}

SAMP::CObjectSA* SAMP::CPedSA::GetAccessory(int nSlot) {
	return ((CObjectSA * (__thiscall*)(CPedSA*, int))SAMP_ADDROF(0x13580))(this, nSlot);
}

char SAMP::CPedSA::GetCameraMode() {
	return ((char(__thiscall*)())SAMP_ADDROF(0x2D00))();
}

void SAMP::CPedSA::GetBonePosition(unsigned int boneId, CVectorSA *outPosition) {
	((void(__thiscall*)(CPedSA*, unsigned int, CVectorSA*))SAMP_ADDROF(0xAE080))(this, boneId, outPosition);
}
