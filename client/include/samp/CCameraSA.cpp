...
SAMP::CCameraSA::CCameraSA() {
	((void(__thiscall*)(CCameraSA*))SAMP_ADDROF(0x9FDA0))(this);
}

SAMP::CCameraSA::~CCameraSA() {
	((void(__thiscall*)(CCameraSA*))SAMP_ADDROF(0x9FDB0))(this);
}

void SAMP::CCameraSA::Fade(BOOL bIn) {
	((void(__thiscall*)(CCameraSA*, BOOL))SAMP_ADDROF(0x9D280))(this, bIn);
}

void SAMP::CCameraSA::GetMatrix(CMatrixSA* pMatrix) {
	((void(__thiscall*)(CCameraSA*, CMatrixSA*))SAMP_ADDROF(0x9D2A0))(this, pMatrix);
}

void SAMP::CCameraSA::SetMatrix(CMatrixSA matrix) {
	((void(__thiscall*)(CCameraSA*, CMatrixSA))SAMP_ADDROF(0x9D320))(this, matrix);
}

void SAMP::CCameraSA::TakeControl(::CEntity* pTarget, short nModeToGoTo, short nTypeOfSwitch) {
	((void(__thiscall*)(CCameraSA*, ::CEntity*, short, short))SAMP_ADDROF(0x9D3B0))(this, pTarget, nModeToGoTo, nTypeOfSwitch);
}

void SAMP::CCameraSA::SetMoveVector(CVectorSA* pCamera, CVectorSA* pPosition, int nTime, bool bSmoothTransmition) {
	((void(__thiscall*)(CCameraSA*, CVectorSA*, CVectorSA*, int, bool))SAMP_ADDROF(0x9D3D0))(this, pCamera, pPosition, nTime, bSmoothTransmition);
}

void SAMP::CCameraSA::SetTrackVector(CVectorSA* pPointAt, CVectorSA* pTransverseTo, int nTime, bool bSmooth) {
	((void(__thiscall*)(CCameraSA*, CVectorSA*, CVectorSA*, int, bool))SAMP_ADDROF(0x9D440))(this, pPointAt, pTransverseTo, nTime, bSmooth);
}

void SAMP::CCameraSA::Attach(CEntitySA* pOwner) {
	((void(__thiscall*)(CCameraSA*, CEntitySA*))SAMP_ADDROF(0x9D4A0))(this, pOwner);
}

void SAMP::CCameraSA::SetToOwner() {
	((void(__thiscall*)(CCameraSA*))SAMP_ADDROF(0x9D4F0))(this);
}

float SAMP::CCameraSA::GetDistanceToPoint(CVectorSA* pPoint) {
	return ((float(__thiscall*)(CCameraSA*, CVectorSA*))SAMP_ADDROF(0x9D540))(this, pPoint);
}

void SAMP::CCameraSA::Restore() {
	((void(__thiscall*)(CCameraSA*))SAMP_ADDROF(0x9D580))(this);
}

void SAMP::CCameraSA::Set(CVectorSA position, CVectorSA rotation) {
	((void(__thiscall*)(CCameraSA*, CVectorSA, CVectorSA))SAMP_ADDROF(0x9D5C0))(this, position, rotation);
}

void SAMP::CCameraSA::PointAt(CVectorSA point, int nSwitchStyle) {
	((void(__thiscall*)(CCameraSA*, CVectorSA, int))SAMP_ADDROF(0x9D620))(this, point, nSwitchStyle);
}

void SAMP::CCameraSA::Detach() {
	((void(__thiscall*)(CCameraSA*))SAMP_ADDROF(0x9D670))(this);
}
