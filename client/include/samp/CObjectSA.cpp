...
SAMP::CObjectSA::CObjectSA(int nModel, CVectorSA position, CVectorSA rotation, float fDrawDistance, int a10, char a11, char a12) {
	((void(__thiscall*)(CObjectSA*, int, CVectorSA, CVectorSA, float, int, char, char))SAMP_ADDROF(0xA8D00))(this, nModel, position, rotation, fDrawDistance, a10, a11, a12);
}

float SAMP::CObjectSA::GetDistance(const CMatrixSA* pMatrix) {
	return ((float(__thiscall*)(CObjectSA*, const CMatrixSA*))SAMP_ADDROF(0xA7BB0))(this, pMatrix);
}

void SAMP::CObjectSA::Stop() {
	((void(__thiscall*)(CObjectSA*))SAMP_ADDROF(0xA7C20))(this);
}

void SAMP::CObjectSA::SetRotation(const CVectorSA* pVector) {
	((void(__thiscall*)(CObjectSA*, const CVectorSA*))SAMP_ADDROF(0xA7C90))(this, pVector);
}

void SAMP::CObjectSA::SetAttachedToVehicle(ID nId, const CVectorSA* pOffset, const CVectorSA* pRotation) {
	((void(__thiscall*)(CObjectSA*, ID, const CVectorSA*, const CVectorSA*))SAMP_ADDROF(0xA7D00))(this, nId, pOffset, pRotation);
}

void SAMP::CObjectSA::SetAttachedToObject(ID nId, const CVectorSA* pOffset, const CVectorSA* pRotation, char a5) {
	((void(__thiscall*)(CObjectSA*, ID, const CVectorSA*, const CVectorSA*, char))SAMP_ADDROF(0xA7D90))(this, nId, pOffset, pRotation, a5);
}

void SAMP::CObjectSA::AttachToVehicle(CVehicleSA* pVehicle) {
	((void(__thiscall*)(CObjectSA*, CVehicleSA*))SAMP_ADDROF(0xA7E30))(this, pVehicle);
}

void SAMP::CObjectSA::AttachToObject(CObjectSA* pObject) {
	((void(__thiscall*)(CObjectSA*, CObjectSA*))SAMP_ADDROF(0xA7EB0))(this, pObject);
}

void SAMP::CObjectSA::Rotate(CVectorSA vector) {
	((void(__thiscall*)(CObjectSA*, CVectorSA))SAMP_ADDROF(0xA7FB0))(this, vector);
}

BOOL SAMP::CObjectSA::AttachedToMovingEntity() {
	return ((BOOL(__thiscall*)(CObjectSA*))SAMP_ADDROF(0xA80B0))(this);
}

void SAMP::CObjectSA::SetMaterial(int nModel, int nIndex, const char* szTxd, const char* szTexture, D3DCOLOR color) {
	((void(__thiscall*)(CObjectSA*, int, int, const char*, const char*, D3DCOLOR))SAMP_ADDROF(0xA8120))(this, nModel, nIndex, szTxd, szTexture, color);
}

void SAMP::CObjectSA::SetMaterialText(int nIndex, const char* szText, char nMaterialSize, const char* szFont, char nFontSize, bool bBold, D3DCOLOR fontColor, D3DCOLOR backgroundColor, char align) {
	((void(__thiscall*)(CObjectSA*, int, const char*, char, const char*, char, bool, D3DCOLOR, D3DCOLOR, char))SAMP_ADDROF(0xA82A0))(this, nIndex, szText, nMaterialSize, szFont, nFontSize, bBold, fontColor, backgroundColor, align);
}

bool SAMP::CObjectSA::GetMaterialSize(int nSize, int* x, int* y) {
	return ((bool(__thiscall*)(CObjectSA*, int, int*, int*))SAMP_ADDROF(0xA8870))(this, nSize, x, y);
}

void SAMP::CObjectSA::Render() {
	((void(__thiscall*)(CObjectSA*))SAMP_ADDROF(0xA8B50))(this);
}

void SAMP::CObjectSA::Process(float fElapsedTime) {
	((void(__thiscall*)(CObjectSA*, float))SAMP_ADDROF(0xA9240))(this, fElapsedTime);
}

void SAMP::CObjectSA::ConstructMaterialText() {
	((void(__thiscall*)(CObjectSA*))SAMP_ADDROF(0xA9AD0))(this);
}

void SAMP::CObjectSA::Draw() {
	((void(__thiscall*)(CObjectSA*))SAMP_ADDROF(0xA9B80))(this);
}

void SAMP::CObjectSA::ShutdownMaterialText() {
	((void(__thiscall*)(CObjectSA*))SAMP_ADDROF(0xA8AC0))(this);
}
