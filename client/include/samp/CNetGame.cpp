...
TICK& SAMP::CNetGame::lastPlayersUpdateRequest() { return *(TICK*)SAMP_ADDROF(0x156B30); }

SAMP::CNetGame::CNetGame(const char* szHostAddress, int nPort, const char* szNick, const char* szPass) {
	((void(__thiscall*)(CNetGame*, const char*, int, const char*, const char*))SAMP_ADDROF(0xB610))(this, szHostAddress, nPort, szNick, szPass);
}

SAMP::CNetGame::~CNetGame() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x9570))(this);
}

SAMP::CPickupPool* SAMP::CNetGame::GetPickupPool() {
	return ((CPickupPool * (__thiscall*)(CNetGame*))SAMP_ADDROF(0x81D0))(this);
}

SAMP::CMenuPool* SAMP::CNetGame::GetMenuPool() {
	return ((CMenuPool * (__thiscall*)(CNetGame*))SAMP_ADDROF(0x81E0))(this);
}

void SAMP::CNetGame::SetState(int nValue) {
	((void(__thiscall*)(CNetGame*, int))SAMP_ADDROF(0x81F0))(this, nValue);
}

void SAMP::CNetGame::InitializePools() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x8230))(this);
}

void SAMP::CNetGame::InitialNotification() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x8450))(this);
}

void SAMP::CNetGame::InitializeGameLogic() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x85E0))(this);
}

void SAMP::CNetGame::Connect() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x8630))(this);
}

void SAMP::CNetGame::SpawnScreen() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x86A0))(this);
}
...
void SAMP::CNetGame::Packet_ConnectionBanned(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0x8A60))(this, pPacket);
}

void SAMP::CNetGame::Packet_ConnectionRequestAcepted(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0x8A80))(this, pPacket);
}

void SAMP::CNetGame::Packet_NoFreeIncomingConnections(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0x8AA0))(this, pPacket);
}

void SAMP::CNetGame::Packet_DisconnectionNotification(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0x8AD0))(this, pPacket);
}

void SAMP::CNetGame::Packet_InvalidPassword(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0x8B10))(this, pPacket);
}

void SAMP::CNetGame::Packet_ConnectionAttemptFailed(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0x8B50))(this, pPacket);
}

void SAMP::CNetGame::UpdatePlayers() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x8C00))(this);
}

void SAMP::CNetGame::DeleteMarker(NUMBER nIndex) {
	((void(__thiscall*)(CNetGame*, NUMBER))SAMP_ADDROF(0x8CA0))(this, nIndex);
}

void SAMP::CNetGame::ResetPlayerPool() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x8CD0))(this);
}

void SAMP::CNetGame::ResetVehiclePool() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x8D70))(this);
}

void SAMP::CNetGame::ResetTextDrawPool() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x8E10))(this);
}

void SAMP::CNetGame::ResetObjectPool() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x8EB0))(this);
}

void SAMP::CNetGame::ResetGangZonePool() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x8F50))(this);
}
...
void SAMP::CNetGame::ResetMenuPool() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x9050))(this);
}

void SAMP::CNetGame::ResetLabelPool() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x90E0))(this);
}

void SAMP::CNetGame::ResetActorPool() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x9180))(this);
}

void SAMP::CNetGame::Packet_UnoccupiedSync(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0x9730))(this, pPacket);
}

void SAMP::CNetGame::Packet_BulletSync(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0x9830))(this, pPacket);
}
...
void SAMP::CNetGame::Packet_TrailerSync(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0x9B10))(this, pPacket);
}

void SAMP::CNetGame::Packet_MarkersSync(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0x9C00))(this, pPacket);
}

void SAMP::CNetGame::Packet_AuthKey(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0x9DF0))(this, pPacket);
}

void SAMP::CNetGame::ResetMarkers() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x9FB0))(this);
}

void SAMP::CNetGame::CreateMarker(NUMBER nIndex, CVectorSA position, char nIcon, int nColor, int nType) {
	((void(__thiscall*)(CNetGame*, NUMBER, CVectorSA, char, int, int))SAMP_ADDROF(0x9FF0))(this, nIndex, position, nIcon, nColor, nType);
}
...
void SAMP::CNetGame::ShutdownForRestart() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0xA230))(this);
}

void SAMP::CNetGame::Packet_PlayerSync(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0xA420))(this, pPacket);
}

void SAMP::CNetGame::Packet_VehicleSync(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0xA6F0))(this, pPacket);
}

void SAMP::CNetGame::Packet_ConnectionLost(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0xA9D0))(this, pPacket);
}

void SAMP::CNetGame::Packet_ConnectionSucceeded(Packet* pPacket) {
	((void(__thiscall*)(CNetGame*, Packet*))SAMP_ADDROF(0xAA60))(this, pPacket);
}

void SAMP::CNetGame::UpdateNetwork() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0xAF40))(this);
}

void SAMP::CNetGame::Process() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0xB290))(this);
}

void SAMP::CNetGame::ProcessGameStuff() {
	((void(__thiscall*)(CNetGame*))SAMP_ADDROF(0x8810))(this);
}

SAMP::CPlayerPool* SAMP::CNetGame::GetPlayerPool() {
	return ((CPlayerPool * (__thiscall*)(CNetGame*))SAMP_ADDROF(0x1170))(this);
}

SAMP::CObjectPool* SAMP::CNetGame::GetObjectPool() {
	return ((CObjectPool * (__thiscall*)(CNetGame*))SAMP_ADDROF(0x2E40))(this);
}

SAMP::CActorPool* SAMP::CNetGame::GetActorPool() {
	return ((CActorPool * (__thiscall*)(CNetGame*))SAMP_ADDROF(0x2E50))(this);
}

int SAMP::CNetGame::GetState() {
	return ((int(__thiscall*)(CNetGame*))SAMP_ADDROF(0x2E60))(this);
}

BOOL SAMP::CNetGame::LanMode() {
	return ((BOOL(__thiscall*)(CNetGame*))SAMP_ADDROF(0x2E70))(this);
}

SAMP::CVehiclePool* SAMP::CNetGame::GetVehiclePool() {
	return ((CVehiclePool * (__thiscall*)(CNetGame*))SAMP_ADDROF(0x1180))(this);
}
...
__int64 SAMP::CNetGame::GetCounter() {
	return ((__int64(__thiscall*)(CNetGame*))SAMP_ADDROF(0x85D0))(this);
}
