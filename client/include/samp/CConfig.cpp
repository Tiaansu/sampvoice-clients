...
SAMP::CConfig*& SAMP::pConfig() { return *(SAMP::CConfig**)SAMP_ADDROF(0x2ACA0C); }

SAMP::CConfig::CConfig(const char* szFile) {
	((void(__thiscall*)(CConfig*, const char*))SAMP_ADDROF(0x65E60))(this, szFile);
}

SAMP::CConfig::~CConfig() {
	((void(__thiscall*)(CConfig*))SAMP_ADDROF(0x65680))(this);
}

void SAMP::CConfig::FindFirstFree() {
	((void(__thiscall*)(CConfig*))SAMP_ADDROF(0x656C0))(this);
}

int SAMP::CConfig::GetIndex(const char* szEntry) {
	return ((int(__thiscall*)(CConfig*, const char*))SAMP_ADDROF(0x65710))(this, szEntry);
}

bool SAMP::CConfig::DoesExist(const char* szEntry) {
	return ((bool(__thiscall*)(CConfig*, const char*))SAMP_ADDROF(0x65D30))(this, szEntry);
}

int SAMP::CConfig::CreateEntry(const char* szName) {
	return ((int(__thiscall*)(CConfig*, const char*))SAMP_ADDROF(0x657B0))(this, szName);
}

int SAMP::CConfig::GetIntValue(const char* szEntry) {
	return ((int(__thiscall*)(CConfig*, const char*))SAMP_ADDROF(0x65890))(this, szEntry);
}

const char* SAMP::CConfig::GetStringValue(const char* szEntry) {
	return ((const char* (__thiscall*)(CConfig*, const char*))SAMP_ADDROF(0x658C0))(this, szEntry);
}

float SAMP::CConfig::GetFloatValue(const char* szEntry) {
	return ((float(__thiscall*)(CConfig*, const char*))SAMP_ADDROF(0x658F0))(this, szEntry);
}

BOOL SAMP::CConfig::Free(const char* szEntry) {
	return ((BOOL(__thiscall*)(CConfig*, const char*))SAMP_ADDROF(0x65920))(this, szEntry);
}

int SAMP::CConfig::GetValueType(const char* szEntry) {
	return ((int(__thiscall*)(CConfig*, const char*))SAMP_ADDROF(0x65980))(this, szEntry);
}

SAMP::CConfig::Entry* SAMP::CConfig::GetEntry(int nIndex) {
	return ((Entry * (__thiscall*)(CConfig*, int))SAMP_ADDROF(0x659B0))(this, nIndex);
}

int SAMP::CConfig::GetType(const char* szString) {
	return ((int(__thiscall*)(CConfig*, const char*))SAMP_ADDROF(0x659E0))(this, szString);
}

BOOL SAMP::CConfig::Save() {
	return ((BOOL(__thiscall*)(CConfig*))SAMP_ADDROF(0x65A50))(this);
}

BOOL SAMP::CConfig::WriteIntValue(const char* szEntry, int nValue, BOOL bReadOnly) {
	return ((BOOL(__thiscall*)(CConfig*, const char*, int, BOOL))SAMP_ADDROF(0x65B00))(this, szEntry, nValue, bReadOnly);
}

BOOL SAMP::CConfig::WriteStringValue(const char* szEntry, const char* szValue, BOOL bReadOnly) {
	return ((BOOL(__thiscall*)(CConfig*, const char*, const char*, BOOL))SAMP_ADDROF(0x65B60))(this, szEntry, szValue, bReadOnly);
}

BOOL SAMP::CConfig::WriteFloatValue(const char* szEntry, float fValue, BOOL bReadOnly) {
	return ((BOOL(__thiscall*)(CConfig*, const char*, float, BOOL))SAMP_ADDROF(0x65C00))(this, szEntry, fValue, bReadOnly);
}

void SAMP::CConfig::Write(const char* szEntry, char* szBuffer) {
	((void(__thiscall*)(CConfig*, const char*, char*))SAMP_ADDROF(0x65C60))(this, szEntry, szBuffer);
}

BOOL SAMP::CConfig::Load() {
	return ((BOOL(__thiscall*)(CConfig*))SAMP_ADDROF(0x65CF0))(this);
}
