...
SAMP::CChat::CChat(IDirect3DDevice9* pDevice, CFonts* pFontRenderer, const char* szLogPath) {
	((void(__thiscall*)(CChat*, IDirect3DDevice9*, CFonts*, const char*))SAMP_ADDROF(0x67DF0))(this, pDevice, pFontRenderer, szLogPath);
}

void SAMP::CChat::RecalcFontSize() {
	((void(__thiscall*)(CChat*))SAMP_ADDROF(0x66B90))(this);
}
...
void SAMP::CChat::UpdateScrollbar() {
	((void(__thiscall*)(CChat*))SAMP_ADDROF(0x66C70))(this);
}

void SAMP::CChat::SetPageSize(int nValue) {
	((void(__thiscall*)(CChat*, int))SAMP_ADDROF(0x66D10))(this, nValue);
}

void SAMP::CChat::PageUp() {
	((void(__thiscall*)(CChat*))SAMP_ADDROF(0x66D40))(this);
}

void SAMP::CChat::PageDown() {
	((void(__thiscall*)(CChat*))SAMP_ADDROF(0x66DA0))(this);
}

void SAMP::CChat::ScrollToBottom() {
	((void(__thiscall*)(CChat*))SAMP_ADDROF(0x66E00))(this);
}

void SAMP::CChat::Scroll(int nDelta) {
	((void(__thiscall*)(CChat*, int))SAMP_ADDROF(0x66E30))(this, nDelta);
}

void SAMP::CChat::FilterOutInvalidChars(char* szString) {
	((void(__thiscall*)(CChat*, char*))SAMP_ADDROF(0x66E90))(this, szString);
}

void SAMP::CChat::PushBack() {
	((void(__thiscall*)(CChat*))SAMP_ADDROF(0x66EC0))(this);
}

void SAMP::CChat::RenderEntry(const char* szText, CRectSA rect, D3DCOLOR color) {
	((void(__thiscall*)(CChat*, const char*, CRectSA, D3DCOLOR))SAMP_ADDROF(0x66EE0))(this, szText, rect, color);
}

void SAMP::CChat::Log(int nType, const char* szText, const char* szPrefix) {
	((void(__thiscall*)(CChat*, int, const char*, const char*))SAMP_ADDROF(0x67240))(this, nType, szText, szPrefix);
}

void SAMP::CChat::ResetDialogControls(CDXUTDialog* pGameUi) {
	((void(__thiscall*)(CChat*, CDXUTDialog*))SAMP_ADDROF(0x67310))(this, pGameUi);
}

void SAMP::CChat::Render() {
	((void(__thiscall*)(CChat*))SAMP_ADDROF(0x673B0))(this);
}

void SAMP::CChat::AddEntry(int nType, const char* szText, const char* szPrefix, D3DCOLOR textColor, D3DCOLOR prefixColor) {
	((void(__thiscall*)(CChat*, int, const char*, const char*, D3DCOLOR, D3DCOLOR))SAMP_ADDROF(0x67650))(this, nType, szText, szPrefix, textColor, prefixColor);
}

void SAMP::CChat::Draw() {
	((void(__thiscall*)(CChat*))SAMP_ADDROF(0x67870))(this);
}

void SAMP::CChat::RenderToSurface() {
	((void(__thiscall*)(CChat*))SAMP_ADDROF(0x67940))(this);
}

void SAMP::CChat::AddChatMessage(const char* szPrefix, D3DCOLOR prefixColor, const char* szText) {
	((void(__thiscall*)(CChat*, const char*, D3DCOLOR, const char*))SAMP_ADDROF(0x67A90))(this, szPrefix, prefixColor, szText);
}

void SAMP::CChat::AddMessage(D3DCOLOR color, const char* szText) {
	((void(__thiscall*)(CChat*, D3DCOLOR, const char*))SAMP_ADDROF(0x67BE0))(this, color, szText);
}

void SAMP::CChat::OnResetDevice() {
	((void(__thiscall*)(CChat*))SAMP_ADDROF(0x67C40))(this);
}

void SAMP::CChat::SwitchMode() {
	((void(__thiscall*)(CChat*))SAMP_ADDROF(0x60D40))(this);
}

int SAMP::CChat::GetMode() {
	return ((int(__thiscall*)(CChat*))SAMP_ADDROF(0x60D30))(this);
}
